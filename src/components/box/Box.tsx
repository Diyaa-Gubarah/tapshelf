...
const Container = styled.div<BoxProps>`
  ...
  padding: ${(props) => (props.padding ? SPACING[props.padding] : 0)};
  margin: ${(props) => (props.margin ? SPACING[props.margin] : 0)};
  border-radius: ${(props) => (props.rounded ? SPACING[props.rounded] : 0)};
